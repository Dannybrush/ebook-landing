...
let selectedChapter = $derived(chapters.find((chapter) => selectedChapterNumber === chapter.number ));

function selectChapter(chapter: { number: any; title?: string; strapline?: string; excerpt?: string; }){ 
